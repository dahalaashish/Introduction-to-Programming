...
# Reads the input fields, validates them, runs the port scan, and displays the results.
...
# Sets up all the input fields, the scan button, and the results text box
def create_gui():
